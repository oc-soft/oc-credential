    ...
    const menuParams = [
      // { role: 'appMenu' }
      {
        ...
        submenu: [
          {
            role: 'about',
            label: util.format(Intl.gettext('About %s'), app.name)
          },
          { type: 'separator' },
          {
            role: 'services',
            label: util.format(Intl.gettext('Services'))
          },
          { type: 'separator' },
          {
            role: 'hide',
            label: util.format(Intl.gettext('Hide %s'), app.name)
          },
          {
            role: 'hideOthers',
            label: util.format(Intl.gettext('Hide Others'))
          },
          {
            role: 'unhide',
            label: util.format(Intl.gettext('Show all'))
          },
          { type: 'separator' },
          {
            role: 'quit',
            label: util.format(Intl.gettext('Quit %s'), app.name)
          }
        ]
      },
      // { role: 'fileMenu' }
      ...
      // { role: 'viewMenu' }
      {
        ...
        submenu: [
          ...
          {
            label: Intl.gettext('Reload no cache'),
            visible: false,
            id: 'force-reload',
            role: 'force-reload'
          },
